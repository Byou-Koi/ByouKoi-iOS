...
//            self.layer.borderWidth = 2.0
    ...
    private lazy var opponentImageView: UIImageView = {
        ...
        opponentImageView.contentMode = .ScaleAspectFill
    ...
    private let minimumHeight: CGFloat = 40.0 // arbitrary minimum height
    ...
    */
    ...
    private func styleTextViewForSentBy(sentBy: LGChatMessage.SentBy) {
        ...
        case .Opponent:
            ...
            self.textView.backgroundColor = UIColor(white: 0.95, alpha: 1.0)
            self.textView.textColor = UIColor.mainTextColor()
//            self.textView.font = UIFont.mainJaFont()
        ...
        case .User:
            self.textView.backgroundColor = UIColor.mainColor()
...
class LGChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate {
    ...
    */
    ...
    private func chatInputConstraints() -> [NSLayoutConstraint] {
        ...
        let rightConstraint = NSLayoutConstraint(item: chatInput, attribute: .Right, relatedBy: .Equal, toItem: self.view, attribute: .Right, multiplier: 1.0, constant: 1.0)
        //高さ40pxという制約を追加
        let heightConstraint = NSLayoutConstraint(item: chatInput, attribute: .Height, relatedBy: .Equal, toItem: nil, attribute: .Height, multiplier: 1.0, constant: 40)
        return [leftConstraint, self.bottomChatInputConstraint, rightConstraint, heightConstraint]
    }
...
class LGChatInput : UIView, LGStretchyTextViewDelegate {
    ...
    */
    ...
    var textViewInsets = UIEdgeInsets(top: 5, left: 5, bottom: 8, right: 16)
    ...
    func setupTextView() {
        textView.font = UIFont.mainJaFont()
    ...
    func setupSendButton() {
        ...
        self.sendButton.setTitle("送信", forState: .Normal)
        self.sendButton.titleLabel?.font = UIFont(name: "HirakakuProN-W6", size: 15)
        self.sendButton.setTitleColor(UIColor.whiteColor(), forState: .Normal)
        self.sendButton.backgroundColor = UIColor.subBlueColor()
    ...
    func setupSendButtonConstraints() {
        ...
        let widthConstraint = NSLayoutConstraint(item: self.sendButton, attribute: .Width, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: 60)
    ...
    func setupTextViewConstraints() {
        ...
        let leftConstraint = NSLayoutConstraint(item: self, attribute: .Left, relatedBy: .Equal, toItem: self.textView, attribute: .Left, multiplier: 0.3, constant: -textViewInsets.left)
        let bottomConstraint = NSLayoutConstraint(item: self, attribute: .Bottom, relatedBy: .Equal, toItem: self.textView, attribute: .Bottom, multiplier: 1, constant: textViewInsets.bottom - 2)
        let rightConstraint = NSLayoutConstraint(item: self.textView, attribute: .Right, relatedBy: .Equal, toItem: self.sendButton, attribute: .Left, multiplier: 1.0, constant: -textViewInsets.right)
